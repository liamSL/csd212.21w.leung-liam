...
// TODO: Implement the HssishSnake class
    class Hssish extends Snake{
        constructor (gridPosition, color){
            super(gridPosition, color);
            this.kind = "Hssish";
        }
        incrementScore(value){
...
const game = {
    ...
    reset : function() {
        ...
        switch(document.getElementById("snake-type").value){
            case "s":
                this.snake = new Snake(this.board.getMidPosition(), settings.snakeColor());
                break;
            case "h":
                this.snake = new Hssish(this.board.getMidPosition(), settings.snakeColor());
                break;
            case "t":
                this.snake = new Tssish(this.board.getMidPosition(), settings.snakeColor());
                break;
            case "k":
                this.snake = new Kssish(this.board.getMidPosition(), settings.snakeColor());
                break;
        }
